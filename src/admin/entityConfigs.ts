...
export const ADMIN_ENTITY_CONFIGS: Record<AdminEntityKey, AdminEntityConfig> = {
  ...
  teams: {
    ...
    fields: [
      ...
      { key: 'active_from', label: 'Active From', type: 'number' },
      { key: 'active_to', label: 'Active To', type: 'number' },
  ...
  drivers: {
    ...
    keyField: 'id',
    defaultSort: 'created_at',
    searchFields: ['name', 'first_name', 'last_name', 'permanent_number', 'nationality'],
    fields: [
      { key: 'first_name', label: 'First Name', type: 'text', required: true },
      { key: 'last_name', label: 'Last Name', type: 'text' },
      { key: 'name', label: 'Display Name', type: 'text', readOnlyOnCreate: true, readOnlyOnEdit: true },
      { key: 'permanent_number', label: 'Permanent Number', type: 'text', required: true },
      { key: 'number', label: 'Legacy Number', type: 'text', readOnlyOnCreate: true, readOnlyOnEdit: true },
  ...
  circuits: {
    ...
    keyField: 'id',
    defaultSort: 'created_at',
    searchFields: ['name', 'country', 'locality'],
    fields: [
      { key: 'name', label: 'Name', type: 'text', required: true },
      ...
      { key: 'layout_image_url', label: 'Layout Image URL', type: 'text' },
    ],
  },
  races: {
    key: 'races',
    ...
    defaultSort: 'date',
    searchFields: ['name'],
    filters: [{ key: 'status', label: 'Status', options: [{ label: 'All', value: '' }, { label: 'Scheduled', value: 'scheduled' }, { label: 'Completed', value: 'completed' }, { label: 'Cancelled', value: 'cancelled' }] }],
    fields: [
      { key: 'name', label: 'Name', type: 'text', required: true },
      { key: 'season_id', label: 'Season', type: 'select', required: true, relation: { table: 'seasons', valueKey: 'id', labelKey: 'year' } },
      ...
      { key: 'status', label: 'Status', type: 'select', required: true, options: [{ label: 'scheduled', value: 'scheduled' }, { label: 'completed', value: 'completed' }, { label: 'cancelled', value: 'cancelled' }] },
    ],
  },
  race_results: {
    key: 'race_results',
    ...
    fields: [
      ...
      { key: 'status', label: 'Status', type: 'select', required: true, options: [{ label: 'Finished', value: 'Finished' }, { label: 'DNF', value: 'DNF' }, { label: 'DSQ', value: 'DSQ' }, { label: 'DNS', value: 'DNS' }] },
    ],
  },
  driver_season_stats: {
